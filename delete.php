...
<div class="well well-sm"> <h1 class="text-center">Delete Contact</h1> </div>
...
$dbcon = mysql_connect($dbhost, $dbuser, $dbpass);
   if (!$dbcon) {
	...
	if(isset($_POST['delete'])){
		$deleteQuery = "DELETE FROM CompanyDetails WHERE id='$_POST[hidden]'";
		mysql_query($deleteQuery, $dbcon);
		}
...
while($records = mysql_fetch_array($myquery)){
	echo "<form id=myForm action=delete.php method=post name=myForm>";
	echo "<tr>";
	...
	echo "<td>" . "<input name=delete type=submit class='form-control btn-danger' value=delete" . " </td>";
	echo "</tr> ";
   	echo "</form> ";
